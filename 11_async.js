...
usingThen(() => console.log('en synchrone, 2 secondes plus tard....'))
...
usingAwait(() => console.log('en asynchrone, 2 secondes plus tard...'))
...
//Env reseau qui injecte un certificat ---> on désactive, ça ne fonctionne pas sinon
