...
const obj = {name: 'toto'}
const obj2 = {name: "toto", password: "1234"}


const extractFirstTwo = ([a, b, ...end]) => [a, b];
...
const extractRest = ([a, ...end]) => [...end];
console.log(extractRest(tab1))
...
const extractName = ({name: n, ...end}) => n;
...
const removePassword = ({password: pwd, ...obj}) => ({...obj});
